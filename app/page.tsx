    ...
    <>
      ...
      <div className="relative max-w-6xl mx-auto rounded-[2.5rem] overflow-hidden bg-bali-deep shadow-xl shadow-bali-deep/20 py-12 md:py-16 px-6">
        <div
          className="absolute inset-0 opacity-10"
          style={{
            backgroundImage: "radial-gradient(ellipse at 30% 50%, rgba(127, 165, 136,0.5) 0%, transparent 60%)",
          }}
        />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-8 items-start">
            <Reveal delay={80} className="lg:col-span-2 space-y-3">
              ...
              >
                ...
                <div>
                  <p className="font-body text-xs text-bali-sand/50 uppercase tracking-wider">Instagram</p>
                  <p className="font-body font-semibold text-white group-hover:text-bali-gold transition-colors">@perle_de_bali</p>
                </div>
              </a>
              <a
