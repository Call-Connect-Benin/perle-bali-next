...
import { FlowerOrnament, ShellOrnament, LeafOrnament, SandScatter } from "@/components/Ornaments";
    ...
    <>
          ...
          <div className="text-center lg:text-left">
            ...
            <div className="flex flex-col sm:flex-row gap-3 justify-center lg:justify-start animate-fade-in-up opacity-0" style={{ animationDelay: "360ms" }}>
              <a
                ...
                className="group inline-flex items-center justify-center gap-2 bg-gradient-to-r from-bali-gold to-bali-rose-deep text-white font-body font-medium px-7 py-3.5 rounded-full shadow-lg shadow-bali-rose-deep/20 hover:shadow-xl hover:shadow-bali-gold/30 hover:-translate-y-0.5 transition-all duration-300"
              >
                <svg className="w-4 h-4 icon-wiggle" fill="currentColor" viewBox="0 0 20 20">
              ...
              <a
                ...
                className="group inline-flex items-center justify-center gap-2 bg-[#25D366] text-white font-body font-medium px-7 py-3.5 rounded-full hover:opacity-90 transition-opacity"
              >
                <svg className="w-4 h-4 icon-wiggle" fill="currentColor" viewBox="0 0 24 24">
      ...
      <div className="relative max-w-6xl mx-auto rounded-[2.5rem] overflow-hidden bg-bali-deep shadow-xl shadow-bali-deep/20 py-12 md:py-16 px-6">
        <div
          className="absolute inset-0 opacity-10"
          style={{
            backgroundImage: "radial-gradient(ellipse at 30% 50%, rgba(107, 145, 114,0.5) 0%, transparent 60%)",
          }}
        />
        ...
        <div className="relative max-w-6xl mx-auto">
          <Reveal className="text-center mb-10 max-w-xl mx-auto">
            ...
            <h2 className="font-display text-3xl md:text-4xl text-white font-semibold mt-2 mb-2">
              Une question ? Réservez ici
            </h2>
            <p className="font-body text-bali-sand/70 text-sm">Réponse sous 24h — ou contactez-moi directement</p>
          </Reveal>

          <div className="grid grid-cols-1 lg:grid-cols-5 gap-8 items-start">
            <Reveal delay={80} className="lg:col-span-2 space-y-3">
              <a
                href="tel:+33756139596"
                className="flex items-center gap-3 p-4 bg-white/5 rounded-xl border border-white/10 hover:border-bali-gold/50 hover:bg-white/[0.07] transition-colors group"
              >
                ...
                <div>
                  <p className="font-body text-xs text-bali-sand/50 uppercase tracking-wider">Téléphone</p>
                  <p className="font-body font-semibold text-white group-hover:text-bali-gold transition-colors">07 56 13 95 96</p>
                </div>
              </a>
              <a
                href="https://wa.me/33756139596"
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-3 p-4 bg-white/5 rounded-xl border border-white/10 hover:border-[#25D366]/50 hover:bg-white/[0.07] transition-colors group"
              >
                ...
                <div>
                  <p className="font-body text-xs text-bali-sand/50 uppercase tracking-wider">WhatsApp</p>
                  <p className="font-body font-semibold text-white group-hover:text-[#25D366] transition-colors">07 56 13 95 96</p>
                </div>
              </a>
              <a
              ...
              >
                ...
                <div>
                  <p className="font-body text-xs text-bali-sand/50 uppercase tracking-wider">Email</p>
                  <p className="font-body text-sm text-white group-hover:text-bali-gold transition-colors">perledebali@gmail.com</p>
                </div>
              </a>
              <div className="flex items-center gap-3 p-4 bg-white/5 rounded-xl border border-white/10">
                ...
                <div>
                  <p className="font-body text-xs text-bali-sand/50 uppercase tracking-wider">Adresse</p>
                  <p className="font-body text-sm text-white">8 rue Jean Jaurès — 94310 Orly</p>
                </div>
              </div>
              <div className="flex items-center gap-3 p-4 bg-white/5 rounded-xl border border-white/10">
                <div className="w-10 h-10 rounded-full bg-bali-gold/15 flex items-center justify-center shrink-0">
