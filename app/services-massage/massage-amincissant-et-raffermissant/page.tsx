  ...
  return (
    <>
      <section className="bg-bali-deep pt-28 pb-20 px-6 relative overflow-hidden">
        ...
        <div className="absolute inset-0 opacity-15" style={{ backgroundImage: "radial-gradient(ellipse at 60% 50%, rgba(107, 145, 114,0.5) 0%, transparent 55%)" }} />
              ...
              <Reveal delay={120}>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                  ...
                  <div className="bg-bali-deep text-white rounded-2xl p-6 shadow-xl relative overflow-hidden card-elevate">
                    <div className="absolute inset-0 opacity-10" style={{ backgroundImage: "radial-gradient(ellipse at 80% 20%, rgba(107, 145, 114,0.6) 0%, transparent 60%)" }} />
