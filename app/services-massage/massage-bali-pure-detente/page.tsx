  ...
  return (
    <>
      <section className="bg-bali-deep pt-28 pb-20 px-6 relative overflow-hidden">
        ...
        <span className="absolute top-[18%] right-[8%] w-1 h-1 rounded-full bg-bali-gold hidden lg:block animate-twinkle" style={{ animationDelay: "0.3s" }} />
        <div className="absolute inset-0 opacity-15 animate-breathe" style={{ backgroundImage: "radial-gradient(ellipse at 50% 50%, rgba(186, 127, 127,0.5) 0%, transparent 55%)" }} />
