    ...
    <>
      ...
      <section className="bg-bali-deep pt-28 pb-20 px-6 relative overflow-hidden">
        ...
        <div
          ...
          style={{
            backgroundImage:
              "radial-gradient(ellipse at 30% 60%, rgba(107, 145, 114,0.4) 0%, transparent 55%)",
          }}
        />
            ...
            {cures.map((cure, i) => (
              ...
              >
                <div
                  ...
                  style={{
                    backgroundImage: "radial-gradient(ellipse at 80% 20%, rgba(107, 145, 114,0.6) 0%, transparent 60%)",
                  }}
                />
