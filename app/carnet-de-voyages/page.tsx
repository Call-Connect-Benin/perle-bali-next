  ...
  return (
    <>
      ...
      <section className="bg-bali-deep pt-28 pb-20 px-6 relative overflow-hidden">
        ...
        <div className="absolute inset-0 opacity-15" style={{ backgroundImage: "radial-gradient(ellipse at 50% 50%, rgba(208, 145, 156,0.4) 0%, transparent 55%)" }} />
              ...
              >
                <div className="w-full aspect-video bg-gradient-to-br from-bali-deep/5 to-bali-gold/10 relative overflow-hidden">
                  {article.image ? (
                    ...
                    <div className="absolute inset-0" style={{ background: "radial-gradient(ellipse at 40% 50%, rgba(107,145,114,0.1) 0%, rgba(208, 145, 156,0.08) 60%, transparent 100%)" }} />
                  )}
