      ...
      <section className="py-20 px-6">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="mt-8 p-6 bg-bali-cream-dark rounded-2xl border border-bali-sand/30">
            ...
            <Link href="/carte-cadeau" className="inline-flex items-center gap-2 bg-bali-gold text-white font-body font-medium px-6 py-2.5 rounded-full hover:bg-bali-deep transition-colors text-sm">
