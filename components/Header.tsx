...
export default function Header() {
  ...
  return (
    <header className="fixed inset-x-0 top-0 z-50 px-3 sm:px-6 pt-3 sm:pt-4">
      ...
      <div className="relative max-w-6xl mx-auto rounded-full bg-gradient-to-r from-bali-deep via-[#9A3D66] to-bali-deep shadow-xl shadow-black/30 border border-white/5">
      ...
      {mobileOpen && (
        <div className="lg:hidden max-w-6xl mx-auto mt-3 rounded-3xl border border-white/10 bg-bali-deep shadow-xl overflow-hidden animate-fade-in-up">
